...
const ChatObj = () => {
  return (
    <>
      <div className="w-[25.25em] h-[21.25em] rounded-3xl mx-2 flex gap-2 relative opacity-20">
        ...
        <div className="absolute w-[17em] h-[15em] bg-[#64748b] rounded-bl-3xl bottom-0 left-0"></div>
      </div>
    </>
  )
}
